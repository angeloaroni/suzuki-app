...
export default async function BooksPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-indigo-950 p-8 transition-colors duration-500">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-md border border-slate-200 dark:border-gray-700">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-slate-600 dark:text-gray-400 text-sm font-medium">Total Libros</p>
                                <p className="text-3xl font-bold text-slate-800 dark:text-slate-100 mt-1">{templates.length}</p>
                            </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-md border border-slate-200 dark:border-gray-700">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-slate-600 dark:text-gray-400 text-sm font-medium">Total Canciones</p>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-md border border-slate-200 dark:border-gray-700">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-slate-600 dark:text-gray-400 text-sm font-medium">Asignaciones</p>
                                <p className="text-3xl font-bold text-slate-800 dark:text-slate-100 mt-1">
